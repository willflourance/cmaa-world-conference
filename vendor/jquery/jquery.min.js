...
if (items.length) {
	...
	/* Toggle sschedule 
            ...
            var $toHighlight = $('.active').next().length > 0 ? $('.active').next() : $('#schedule li').first();
            $('.active').removeClass('active');
            $toHighlight.addClass('active');
        });

        $("a.prev").click(function(){
            var $toHighlight = $('.active').prev().length > 0 ? $('.active').prev() : $('#schedule li').last();
            $('.active').removeClass('active');
            $toHighlight.addClass('active');
        });
	*/
